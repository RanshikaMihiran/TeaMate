...
export default class Water_Auto extends React.Component {

  static navigationOptions = ({ navigation }) => ({
    title: 'Water Condition (A)',
    headerStyle: {
      backgroundColor: '#008000', // Changed header background color to green
      elevation: 0,
    },
  ...
  componentDidMount = async() => {
    ...
    await axios.get(url, {
      ...
      this.setState({loader:false,humidity:res.data.humidity+"",temperature:res.data.temperature+""})
    })
  }
...
const styles = StyleSheet.create({
  ...
  loginButton: {
    backgroundColor: "#008000", // Changed button color to green
  },
  registerButton: {
